 ...
 * @author HB
 */
@WebServlet(name = "CreateUserServlet", urlPatterns = {"/create_user"})
public class CreateUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("crud_user/create_user.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Integer checkCreate = newUserService.create(newUser);
            if (checkCreate == null) {
